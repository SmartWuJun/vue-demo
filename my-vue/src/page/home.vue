    ...
    export default {
    	...
    	methods: {
    		async initData(){
                ...
                // try{
                //     this.apiCount = (await apiCount(today)).count;
    			// 	this.userCount = (await userCount(today)).count;
    			// 	this.orderCount =(await orderCount(today)).count;
                //     this.adminCount = (await adminDayCount(today)).count;
                //     this.allApiCount = (await apiAllCount()).count;
                //     this.allUserCount = (await getUserCount()).count;
                //     this.allOrderCount = (await getOrderCount()).count;
                //     this.allAdminCount = (await adminCount()).count;
                // }catch(err ) {
                //     log(err);
                // }
    		},
